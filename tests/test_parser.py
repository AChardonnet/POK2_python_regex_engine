...
def test_alternation_long_parsing():
    assert parser.parse_alternation("ab|cd", 0) == (
        5,
        ("alternation", ("concatenation", "a", "b"), ("concatenation", "c", "d")),
    )


def test_alternation_multiple_parsing():
    assert parser.parse_alternation("a|b|c", 0) == (
        5,
...
def test_concatenation_long_parsing():
    assert parser.parse_concatenation("abc", 0) == (
        3,
        ("concatenation", ("concatenation", "a", "b"), "c"),
    )
    assert parser.parse_concatenation("abcd", 0) == (
        4,
        ("concatenation", ("concatenation", ("concatenation", "a", "b"), "c"), "d"),
    )
...
def test_alternation_parenthesis_parsing():
    ...
    assert parser.parse_alternation("ab(cd|ef)", 0) == (
        9,
        (
            "concatenation",
            ("concatenation", "a", "b"),
            ("alternation", ("concatenation", "c", "d"), ("concatenation", "e", "f")),
        ),
    )
...
def test_repeat_parsing():
    ...
    assert parser.parse_alternation("a?", 0) == (2, ("repeat", "a", 0, 1))
